    ...
    <div style={{ background: '#F8FAFC', color: '#1E293B', fontFamily: "'Figtree', 'Noto Sans', sans-serif", minHeight: '100vh', overflowX: 'hidden' }}>
      ...
      <section id="pricing" style={{ padding: '80px 20px', maxWidth: 1100, margin: '0 auto' }}>
        ...
        <div style={{ marginTop: 48, fontSize: 13, color: '#94A3B8', lineHeight: 1.6, textAlign: 'left', maxWidth: 1100, borderTop: '1px solid #E2E8F0', paddingTop: 24 }}>
          * Один диалог рассчитывается как средняя сессия из 5 вопросов и ответов. Фактический учет ведется в токенах (слова и символы, обрабатываемые нейросетью). В тариф «Старт» включено 2 млн токенов, «Бизнес» — 10 млн токенов, «Про» — 50 млн токенов. При исчерпании пакета на тарифах «Бизнес» и «Про» система автоматически переходит на оплату за сверхлимит с вашего авансового баланса. Платформа не предоставляет услуги в кредит.
        </div>
      </section>
