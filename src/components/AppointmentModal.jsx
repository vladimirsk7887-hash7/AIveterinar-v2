...
import { TG_BOT_USERNAME, SUMMARY_PROMPT } from '../lib/constants';

export default function AppointmentModal({ pet, messages, onClose }) {
  ...
  const handleSubmit = async () => {
    ...
    if (sent) {
      ...
      setStep("ready"); // fallback to copy-paste
    }
  };
        ...
        <div className="modal-body" style={{ padding: "24px 28px", maxHeight: "70vh", overflowY: "auto" }}>
          ...
          {step === "ready" && (
            <div style={{ animation: "fadeIn 0.4s ease" }}>
              ...
              />
              <div style={{ textAlign: "center", margin: "12px 0", fontSize: 12, color: "#FFD740", fontWeight: 600 }}>
                Нажмите на текст, затем Ctrl+C / Cmd+C
              </div>
              <a href={`https://t.me/${TG_BOT_USERNAME}`} target="_blank" rel="noopener noreferrer" style={{
                display: "flex", width: "100%", padding: "15px", borderRadius: 14, border: "none",
                fontFamily: "inherit", textDecoration: "none",
                background: "linear-gradient(135deg, #00C853, #00E676)",
                color: "#0B0E18", cursor: "pointer", fontSize: 15, fontWeight: 800,
                boxShadow: "0 4px 24px rgba(0,200,83,0.3)",
                alignItems: "center", justifyContent: "center", gap: 10,
              }}>
                <span style={{ fontSize: 18 }}>✈️</span> Открыть Telegram и вставить
              </a>
              <button onClick={onClose} style={{
